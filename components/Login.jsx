...
const Login = () => {
  ...
  return (
    <div className="flex flex-col min-w-[80%] h-full min-h-[80vh] justify-center items-center">
      ...
      <a href="/api/auth/login" className="text-2xl font-semibold text-primary underline px-2.5 border-2 border-[#fff0] py-1 hover:no-underline hover:border-primary hover:border-2">Login or Sign up</a>
    </div>
  );
};
